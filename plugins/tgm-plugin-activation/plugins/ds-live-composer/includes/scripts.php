...
function dslc_load_scripts() {
	...
	$translation_array = array( 
		...
		'str_exit_descr' => __( 'Any unsaved changed will be lost.', 'dslc_string' ),
		...
		'str_refresh_descr' => __( 'Any unsaved changed will be lost.', 'dslc_string' ),
...
function dslc_load_admin_scripts( $hook ) {	
	...
	if ( ( $hook == 'post-new.php' || $hook == 'post.php' ) && DS_LIVE_COMPOSER_LOAD_MINIFIED ) {
		wp_enqueue_script( 'dslc-post-options-js-admin', DS_LIVE_COMPOSER_URL . 'includes/post-options-framework/js/main.min.js', array( 'jquery' ), DS_LIVE_COMPOSER_VER );
