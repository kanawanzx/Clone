...
class Heli_Accordion extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'Heli_Accordion';
		$this->module_title = __( 'Heli Accordion', 'dslc_string' );
	...
	function options() {	
		...
		$dslc_options = array(
			...
			array(
				'label' => __( '(hidden) Accordion Image', 'dslc_string' ),
				'id' => 'accordion_image',
				'std' => '',
				'type' => 'image',
				'visibility' => 'hidden',
			...
			array(
				'label' => __( 'Margin Top First Child', 'dslc_string' ),
				'id' => 'css_margin_top_first',
				'std' => '0',
				'type' => 'slider',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.dslc-accordion-item:first-child',
				'affect_on_change_rule' => 'margin-top',
				'section' => 'styling',
				'ext' => 'px',
			),
			...
			array(
				...
				'id' => 'css_title_bg_color_hover',
				'std' => '',
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.dslc-accordion-title:hover',
				'affect_on_change_rule' => 'background-color',
				'section' => 'styling',
				'tab' => __( 'title', 'dslc_string' )
			),
			...
			array(
				...
				'id' => 'css_title_bg_color_active',
				'std' => '',
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.dslc-active .dslc-accordion-title',
				'affect_on_change_rule' => 'background-color',
				'section' => 'styling',
				'tab' => __( 'title', 'dslc_string' )
			),
			...
			array(
				...
				'id' => 'css_title_border_color_hover',
				'std' => '',
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.dslc-accordion-title:hover',
			...
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.dslc-accordion-title:hover .dslc-icon',
				'affect_on_change_rule' => 'color',
				'section' => 'styling',
				'tab' => __( 'Icon', 'dslc_string' ),
			),
			...
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.dslc-active .dslc-accordion-title .dslc-icon',
				'affect_on_change_rule' => 'color',
				'section' => 'styling',
				'tab' => __( 'Icon', 'dslc_string' ),
			),
			...
			array(
				...
				'id' => 'css_icon_title-width',
				'std' => '30',
				'type' => 'slider',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.dslc-accordion-title .dslc-icon',
				...
				<div class="dslc-accordion" data-open="<?php echo $options['open_by_default']; ?>">
						...
						<?php foreach ( $accordion_contents as $accordion_content ) : ?>
							...
							<div class="dslc-accordion-item">
								...
								<div class="dslc-accordion-header dslc-accordion-hook">
									<span class="as-accordion-title dslc-accordion-title" <?php if ( $dslc_is_admin ) echo 'contenteditable'; ?>><?php echo stripslashes( $accordion_nav[$count] ); ?>
									<?php if( $options['css_icon_hide_show'] == 'enabled' ){?>
										<span class="dslc-icon dslc-icon-<?php echo $options['icon_id']; ?> dslc-init-center as-icon-header-accordion"></span>
									<?php } ?>
									</span>
					...
					<?php else : ?>
						...
						<div class="dslc-accordion-item">
							...
							<div class="dslc-accordion-header dslc-accordion-hook">
								<span class="dslc-accordion-title" <?php if ( $dslc_is_admin ) echo 'contenteditable'; ?>><?php _e( 'CLICK TO EDIT', 'dslc_string' ); ?>
