...
class Heli_Timeline extends DSLC_Module
{
    ...
    function output($options)
    {
        ...
        <div id="cd-timeline" class="dslc-accordion cd-container" data-open="<?php echo $options['open_by_default']; ?>">

            <?php if (is_array($accordion_contents) && count($accordion_contents) > 0) : ?>

                <?php foreach ($accordion_contents as $accordion_content) : ?>

                    <div class="dslc-accordion-item cd-timeline-block dslc-active">
                        ...
                        <div class="cd-timeline-content">
                            ...
                            <span class="cd-date dslc-accordion-date" <?php if ($dslc_is_admin) echo 'contenteditable'; ?>><?php echo stripslashes($accordion_date[$count]); ?></span>
                        </div>
                    ...
                    <div class="cd-timeline-content">
                        ...
                        <div class="dslc-accordion-content">
                            ...
                            <?php if ($dslc_is_admin) : ?>
                                ...
                                <div class="dslca-wysiwyg-actions-edit"><span class="dslca-wysiwyg-actions-edit-hook"><?php _e('Edit Content', 'dslc_string'); ?></span></div>
                            <?php endif; ?>
                            <span class="cd-date dslc-accordion-date" <?php if ($dslc_is_admin) echo 'contenteditable'; ?>>Click to Edit</span>
                        </div><!-- .dslc-accordion-content -->
                    </div>
                </div><!-- .dslc-accordion-item -->
