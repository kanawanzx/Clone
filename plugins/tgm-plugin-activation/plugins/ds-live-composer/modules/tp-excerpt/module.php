...
class DSLC_TP_Excerpt extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_title = __( 'The Excerpt', 'dslc_string' );
	...
	function output( $options ) {
		...
		if ( $dslc_is_admin )
			$the_excerpt = __( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'dslc_string' );
		else
			$the_excerpt = false;
