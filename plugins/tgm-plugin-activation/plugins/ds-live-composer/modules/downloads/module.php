...
class DSLC_Downloads extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_title = __( 'Downloads', 'dslc_string' );
	...
	function options() {
		...
		$dslc_options = array(
			...
			array(
				...
				'choices' => array(
					array(
						'label' => __( 'Link to download item page', 'dslc_string' ),
						'value' => 'enabled'
					),
					array(
						'label' => __( 'Do NOT link to download item page', 'dslc_string' ),
						'value' => 'disabled'
					),
				)
			),
	...
	function output( $options ) {
		 ...
		 */
			...
			if ( $dslc_query->have_posts() ) :
				...
				if ( $dslc_is_admin ) :
					?><div class="dslc-notification dslc-red"><?php _e( 'You do not have downloads at the moment. Go to <strong>WP Admin &rarr; Downloads</strong> to add some.', 'dslc_string' ); ?> <span class="dslca-refresh-module-hook dslc-icon dslc-icon-refresh"></span></span></div><?php
				endif;
