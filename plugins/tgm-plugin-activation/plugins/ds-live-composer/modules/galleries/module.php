									...
									<div class="dslc-post-thumb dslc-gallery-thumb dslc-on-hover-anim">
										...
										<div class="dslc-gallery-thumb-inner dslca-post-thumb">
											...
											<?php if ( $manual_resize ) : ?>
												<a href="<?php the_permalink(); ?>" class="<?php echo $thumb_anchor_class; ?>"><img src="<?php $res_img = dslc_aq_resize( $thumb_url, $resize_width, $resize_height, true ); echo $res_img; ?>" alt="<?php echo $thumb_alt; ?>" /></a>
											<?php else : ?>
