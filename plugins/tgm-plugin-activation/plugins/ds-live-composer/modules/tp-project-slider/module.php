...
class DSLC_TP_Project_Slider extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_title = __( 'Project Images Slider', 'dslc_string' );
	...
	function options() {	
		...
		$dslc_options = array(
			...
			array(
				...
				'affect_on_change_rule' => 'background-color',
				'section' => 'styling',
				'tab' => __( 'slider - item', 'dslc_string' ),
			),
			array(
				'label' => __( 'Border Color', 'dslc_string' ),
								...
								<?php 
									...
									if ( $show_placeholder ) {
										...
										foreach ( $project_images as $project_image ) {
											...
											?><div class="dslc-slider-item"><img src="<?php echo $project_image_src; ?>" alt="<?php echo $thumb_alt; ?>" /></div><?php
